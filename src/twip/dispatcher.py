...
def _handle_targeted_action(world: World, action: Action) -> Result:
...
def _handle_targetless_action(world: World, action: Action) -> Result:
...
def _handle_current_room_action(world: World, action: Action) -> Result | None:
...
def _handle_player_action(world: World, action: Action) -> Result | None:
